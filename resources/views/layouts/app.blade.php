    ...
    $structuredData = [
        ...
        '@graph' => [
            ...
            [
                ...
                'telephone' => array_values($seo['phones']),
            ...
            [
                ...
                'mainEntity' => [
                    [
                        '@type' => 'Question',
                        'name' => 'Who is Allen Christopher Aduan?',
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' => 'Allen is a Filipino software engineer based in Dubai, United Arab Emirates, with experience across software development, web development, network engineering, and IT support.'
                        ]
                    ],
                    [
                        '@type' => 'Question',
                        'name' => 'What does Allen specialize in?',
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' => 'He specializes in Laravel and PHP applications, RESTful APIs, PostgreSQL-backed systems, payment integrations, financial ledgers, and responsive product interfaces.'
                        ]
                    ],
                    [
                        '@type' => 'Question',
                        'name' => 'What has Allen built?',
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' => 'Selected work includes a Stripe payment operations platform, LedgerFlow\'s double-entry wallet architecture, and FinShield, a multi-tenant transaction risk and fraud investigation case study.'
                        ]
                    ],
                    [
                        '@type' => 'Question',
                        'name' => 'Is Allen available for opportunities?',
                        'acceptedAnswer' => [
                            '@type' => 'Answer',
                            'text' => 'Yes. Allen is open to software engineering roles, ambitious product work, and conversations with thoughtful teams in Dubai and internationally.'
                        ]
                    ]
                ]
            ],
